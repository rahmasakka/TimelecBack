package com.timelec.timelec.sircoSircover.service;
...
public class SircoSircoverService {
	...
	@Autowired 
	SircoSircoverRepository productionRepository;
	...
	public Page<Summary>listSummaryBetweenTwoDays(Date jour1, Date jour2, int pageNumber, int pageSize){
		Pageable page = PageRequest.of(pageNumber, pageSize);
		return productionRepository.listSummaryBetweenTwoDays(jour1, jour2, page);
	}
