...
import com.timelec.timelec.p77.service.P77Service;

@CrossOrigin
@RestController
@RequestMapping("/api/p77")
public class P77Controller {

	@Autowired
    private P77Repository productionRepository;
	
    @Autowired 
    private P77Service productionService;
