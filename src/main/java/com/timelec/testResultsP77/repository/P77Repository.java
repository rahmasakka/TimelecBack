package com.timelec.testResultsP77.repository;
...
@Repository
public interface P77Repository extends JpaRepository<Summary, Long>{
	...
	@Query(value="select Convert(Test_start_time, time) from table_summary "
